...
const messages = {
  "zh-CN": {
    ...
    "general.appearanceDescription": "让 V2Note 适应你的工作环境。",
    "general.theme": "主题",
    "general.colors": "配色",
  ...
  en: {
    ...
    "general.appearanceDescription": "Make V2Note fit the way you work.",
    "general.theme": "Theme",
